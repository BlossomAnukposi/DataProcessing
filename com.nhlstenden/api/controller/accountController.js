...
=======
    ...
    async createAccount(req, res) {
        ...
        try {
            ...
            const account = await AccountModel.createAccountWithRetry(email, password, invitedByAccountId);

            if (!account) {
                return this.sendResponse(res, 500, "Failed to create account", null, isXml);
            }
...
>>>>>>> 660d07bce701844bce8fae99a0d1a7e292e6bd70
    }
  }
}
